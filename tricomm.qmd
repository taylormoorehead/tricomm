...
drug_fit <- linear_reg() |>
  set_engine("lm") |>
  fit(Prescriptions_Per_Population ~ TotalWorkMale + TotalWorkFemale + TotalPovertyMale + TotalPovertyFemale + TotalInsuredMale + TotalUninsuredMale + TotalInsuredFemale + TotalUninsuredFemale + TotalAgeMale + TotalAgeFemale, data = census_summarized)
